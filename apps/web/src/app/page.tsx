...
import { AtSign, Eye, EyeOff, Key, Lock, User } from "lucide-react";
...
function LoginForm() {
	...
	return (
		<div
			...
			style={{
				background:
					"radial-gradient(circle at top right, rgba(14,77,110,0.2) 0%, #0a0e1a 50%, #0a0e1a 100%)",
			}}>
			{/* Ambient glows */}
			<div
				className="fixed top-[-10%] right-[-5%] w-96 h-96 rounded-full pointer-events-none"
				style={{
			...
			<main className="w-full max-w-md z-10">
				...
				<div className="glass-panel p-8 rounded-xl shadow-2xl relative overflow-hidden">
					<div
						className="absolute -top-full left-[-100%] w-[200%] h-[200%] pointer-events-none"
						style={{
							background:
