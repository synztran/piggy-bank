  ...
  return (
    <div className="space-y-6">
      ...
      <section className="relative group">
        ...
        />
        <div className="relative glass-panel-elevated p-7 rounded-xl shadow-[0_0_40px_rgba(125,211,252,0.1)] overflow-hidden">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 glass-panel hover:bg-[rgba(125,211,252,0.1)] text-[#7dd3fc] py-3 rounded-lg font-semibold flex items-center justify-center gap-2 transition-all active:scale-95 border-[rgba(125,211,252,0.2)]"
            >
              <RefreshCw size={18} />
              Cập nhật số dư
            </button>
